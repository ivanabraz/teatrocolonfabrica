...
const NavBarLanguage = () => {
    ...
    return (
        <div className="flex border-t border-neutral-200 lg:border-none px-4 py-6">
            <button onClick={toggleLanguage} className={'m-2 flex items-center'}>
                ...
                />
                <span className="ml-3 block text-base font-medium text-neutral-900 sm:text-neutral-900 lg:text-white uppercase">{languages[oppositeLanguageIndex].code}</span>
